...
- If you are new to Neovim and wish to give it a try go to [[content/Neovim for Embedded/Neovim Quick Start|Neovim 0.12 Quick Start]] where I will go over a way to get started quickly with a **minimalist** config that I personally wish I had started with
...
- Formatting ant linting are a requirement for most if not all modern languages. C is not too far behind and has some good options that are relatively easy to add to Neovim. Once you have LSP working you can head over to [[formatters-and-linters|Neovim as your Embedded IDE - Formatters and Linters]]
